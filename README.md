...
## LOG
May/08/26: r0.901 : Renamed to hudn_quirotablero

Abr/28/26: r1.13 : Preparing for deploying on win linux VM. Added secret.

Abr/17/26: r1.12 : Added telefono to paciente dialog. Added notifications by SMSs using twinlio.

Abr/17/26: r1.11 : Removed RegistroEstados. Added button for loading new patients. Fixed GUI table ordering and dates

Abr/14/26: r1.10 : Fixed OTRO. Identificacion and labelOtro in DB. Vertical Layout for tablero

Abr/14/26: r1.00 : First running version: working basic app.

Abr/13/26: r0.01 : Finished specs for reqs and design. Creating specs for tasks
